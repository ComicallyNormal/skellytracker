...
from skellytracker.trackers.mediapipe_tracker.__mediapipe_tracker import MediapipeTracker
from skellytracker.trackers.mediapipe_gpu_tracker.__mediapipe_gpu_tracker import MediapipeGPUTracker
...
def main(demo_tracker: str = "mediapipe_holistic_tracker"):
    ...
    if demo_tracker == "charuco_tracker":
        charuco_squares_x = 7
        charuco_squares_y = 5
    ...
    elif demo_tracker == "mediapipe_tracker":
        MediapipeTracker.create().demo()

    elif demo_tracker == "mediapipe_gpu_tracker":
        print("trying the gpu one")
        MediapipeGPUTracker.create().demo()



if __name__ == "__main__":
    main(demo_tracker="mediapipe_gpu_tracker")
